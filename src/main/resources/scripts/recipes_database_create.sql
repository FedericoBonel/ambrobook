...
create table unit_of_measure (id bigint not null auto_increment, unit varchar(255), primary key (id)) engine=InnoDB;
...
alter table recipe add constraint FKn6fgma2goebs3vy622gmwq7qh foreign key (note_id) references notes (id);
